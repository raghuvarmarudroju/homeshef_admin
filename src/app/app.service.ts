...
//-------------------------------------------------Login----------------------------------------//
  ...
  //--------------------------------------------Products----------------------------------------------//
  public getProducts(input : any): Observable<any>{
    return this.http.post(environment.adminURL + 'products', input,httpOptions)
  }
   public profile(input:any){
    ...
    return this.http.post(environment.baseURL + 'shef/edit_profile', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public productById(id:number): Observable<any>{
    return this.http.get<any[]>(environment.adminURL + 'products/'+id,httpOptions);
  }
//--------------------------------------------Products----------------------------------------------//
...
public updateChef(input:any){
  ...
  return this.http.post(environment.adminURL + 'rider/update', input,httpOptions)
    .pipe(
      map(
        (response:any) => {
          if (response) {
...
public updateChefStatus(input:any){
  const httpOptions = {
    headers: new HttpHeaders({
      "basic": environment.basic
    })
...
public registerRider(input: any) {
  ...
  return this.http.post(environment.adminURL + 'rider/register', input, httpOptions)
      .pipe(
          map(
              (response: any) => {
                  if (response) {
...
public getRiders() {
  return this.http.get<any[]>(environment.adminURL + 'riders',  httpOptions);
}
//--------------------------------------------rider----------------------------------------------//
...
public editAddress(input:any){
  ...
  public updateProfile(input:any){
    ...
    return this.http.post(environment.baseURL + 'shef/update_profile', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public assignRider(input: any){
    ...
    return this.http.post(environment.adminURL + 'order/assign_rider', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public getIngredients(): Observable<any[]>{
    return this.http.get<any[]>(environment.adminURL + 'ingredients',httpOptions);
  }
  public saveIngredient(input:any){
    return this.http.post(environment.adminURL + 'ingredient/create', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public updateIngredient(input:any){
    return this.http.post(environment.adminURL + 'ingredient/update', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public deleteIngredient(input:any){
    return this.http.post(environment.adminURL + 'ingredient/delete', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public saveCuisine(input:any){
    return this.http.post(environment.adminURL + 'cuisine/create', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public updateCuisine(input:any){
    return this.http.post(environment.adminURL + 'cuisine/update', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public getCategories(): Observable<any[]>{
    return this.http.get<any[]>(environment.adminURL + 'food_types',httpOptions);
  } 

  public saveFoodType(input:any){
    return this.http.post(environment.adminURL + 'food_types/create', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public updateFoodType(input:any){
    return this.http.post(environment.adminURL + 'food_types/edit', input,httpOptions)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public getStores(): Observable<Category[]>{
    return this.http.get<any[]>(environment.adminURL + 'storelocators');
  }
  public getHomeCarouselSlides(){
    const input = {
      postal_code: 500018
    };
    return this.http.post(environment.baseURL + 'home/banners', input)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public getStock(id:any): Observable<any[]>{
    return this.http.get<any[]>(environment.adminURL + 'stock/'+id);
  }

  public getFoodTags(): Observable<any> {
    return this.http.get<any[]>(environment.baseURL+'food_tags');
  }
  /*
  public getFoodTags() {
    return this.http.get(environment.baseURL+'food_tags').pipe(map((data: any) => data.data.food_tags ));
   }
  */
  public getFoodTypes(): Observable<any> {
    return this.http.get<any[]>(environment.baseURL+'food_types');
  }


  public getUnits(): Observable<any> {
    return this.http.get<any[]>(environment.baseURL+'size_units');
  }

  public getShefs(): Observable<any> {
    return this.http.get<any[]>(environment.baseURL+'chefs');
  }

  public saveChefItem(input: any) {
    return this.http.post(environment.baseURL+'save_chef_item', input)
    .pipe(
      map(
        (response:any) => {
          if (response) {
  ...
  public getStockk(id:any,input :any){
    return this.http.post(environment.adminURL + 'stockk/'+id, input)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public businessStock(input :any){
    return this.http.post(environment.adminURL + 'business_stock', input)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public storeStock(input :any){
    return this.http.post(environment.adminURL + 'store_stock', input)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public updateStock(input :any){
    return this.http.post(environment.adminURL + 'stock_update', input)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public TransferStock(input :any){
    return this.http.post(environment.adminURL + 'transfer_stock', input)
      .pipe(
        map(
          (response:any) => {
            if (response) {
  ...
  public orderInvoice(id:any){
    const headers = new HttpHeaders().set('Content-Type', 'html/plain; charset=utf-8');
    return this.http.get(environment.adminURL + 'print-invoice/'+id,{ headers, responseType: 'text'});
  }
  public getOrders(input: any){
    const httpOptions = {
      headers: new HttpHeaders({
        "basic": environment.basic
      })
