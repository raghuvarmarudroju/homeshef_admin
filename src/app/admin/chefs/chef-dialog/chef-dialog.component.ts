...
import { User, UserProfile, UserWork, UserContacts, UserSocial, UserSettings, Address } from '../../users/user.model';
...
export class ChefDialogComponent implements OnInit {
  ...
  constructor(public snackBar: MatSnackBar,public dialogRef: MatDialogRef<ChefDialogComponent>,
